package com.nino.blindbox.ui.widget.view;
...
public class TabIndicator extends RelativeLayout {
    ...
    private final TextView tvTabHint;
    private final TextView tvTabUnRead;
    ...
    public void setTextColor(boolean selected) {
        if (selected) {
            tvTabHint.setTextColor(ResUtils.Companion.getColor(R.color.colorPrimaryT));
        } else {
            tvTabHint.setTextColor(ResUtils.Companion.getColor(R.color.font_666666));
        }
    }
}
